...
namespace AOS::Rexxsyslib
{
    ...
    struct Library
    {
        ...
        /// @brief calls rexxsyslib.library/CreateArgstring
        static unsigned char *libCreateArgstring(const std::string &string) noexcept;
        /// @brief calls rexxsyslib.library/DeleteArgstring
        ...
        /// @brief calls rexxsyslib.library/CreateRexxMsg
        ...
        /// @brief calls rexxsyslib.library/DeleteRexxMsg
        static void libDeleteRexxMsg(struct RexxMsg &rexxMsg) noexcept;
        /// @brief calls rexxsyslib.library/ClearRexxMsg - Releases and clears the argument array in a RexxMsg
