...
namespace AOS
{
    ...
    // Scrollbar
        ...
        /*
                // TextEditor
                MAP_PAIR(MUIA_TextEditor_Contents, ValueType::),
                MAP_PAIR(MUIA_TextEditor_CursorX, ValueType::),
                MAP_PAIR(MUIA_TextEditor_CursorY, ValueType::),
                MAP_PAIR(MUIA_TextEditor_DoubleClickHook, ValueType::),
                MAP_PAIR(MUIA_TextEditor_TypeAndSpell, ValueType::),
                MAP_PAIR(MUIA_TextEditor_ExportHook, ValueType::),
                MAP_PAIR(MUIA_TextEditor_ExportWrap, ValueType::),
                MAP_PAIR(MUIA_TextEditor_FixedFont, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Flow, ValueType::),
                MAP_PAIR(MUIA_TextEditor_HasChanged, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Prop_DeltaFactor, ValueType::),
                MAP_PAIR(MUIA_TextEditor_ImportHook, ValueType::),
                MAP_PAIR(MUIA_TextEditor_InsertMode, ValueType::),
                MAP_PAIR(MUIA_TextEditor_ImportWrap, ValueType::),
                MAP_PAIR(MUIA_TextEditor_KeyBindings, ValueType::),
                MAP_PAIR(MUIA_TextEditor_UndoAvailable, ValueType::),
                MAP_PAIR(MUIA_TextEditor_RedoAvailable, ValueType::),
                MAP_PAIR(MUIA_TextEditor_AreaMarked, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Prop_Entries, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Prop_Visible, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Quiet, ValueType::),
                MAP_PAIR(MUIA_TextEditor_NumLock, ValueType::),
                MAP_PAIR(MUIA_TextEditor_ReadOnly, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Slider, ValueType::),
                MAP_PAIR(MUIA_TextEditor_InVirtualGroup, ValueType::),
                MAP_PAIR(MUIA_TextEditor_StyleBold, ValueType::),
                MAP_PAIR(MUIA_TextEditor_StyleItalic, ValueType::),
                MAP_PAIR(MUIA_TextEditor_StyleUnderline, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Prop_First, ValueType::),
                MAP_PAIR(MUIA_TextEditor_WrapBorder, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Separator, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Pen, ValueType::),
                MAP_PAIR(MUIA_TextEditor_ColorMap, ValueType::),
                MAP_PAIR(MUIA_TextEditor_MultiColorQuoting, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Rows, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Columns, ValueType::),
                MAP_PAIR(MUIA_TextEditor_AutoClip, ValueType::),
                MAP_PAIR(MUIA_TextEditor_CursorPosition, ValueType::),
                MAP_PAIR(MUIA_TextEditor_KeyUpFocus, ValueType::),
                MAP_PAIR(MUIA_TextEditor_UndoLevels, ValueType::),
                MAP_PAIR(MUIA_TextEditor_WrapMode, ValueType::),
                MAP_PAIR(MUIA_TextEditor_ActiveObjectOnClick, ValueType::),
                MAP_PAIR(MUIA_TextEditor_PasteStyles, ValueType::),
                MAP_PAIR(MUIA_TextEditor_PasteColors, ValueType::),
                MAP_PAIR(MUIA_TextEditor_ConvertTabs, ValueType::),
                MAP_PAIR(MUIA_TextEditor_WrapWords, ValueType::),
                MAP_PAIR(MUIA_TextEditor_TabSize, ValueType::),
                MAP_PAIR(MUIA_TextEditor_Keywords, ValueType::),
                MAP_PAIR(MUIA_TextEditor_MatchedKeyword, ValueType::),
                MAP_PAIR(MUIA_TextEditor_CursorIndex, ValueType::),
                MAP_PAIR(MUIA_TextEditor_RGBMode, ValueType::),
                MAP_PAIR(MUIA_TextEditor_HorizontalSlider, ValueType::),
                MAP_PAIR(MUIA_TextEditor_GlobalFlow, ValueType::),
                MAP_PAIR(MUIA_TextEditor_ContentsChanged, ValueType::),
                MAP_PAIR(MUIA_TextEditor_MetaDataChanged, ValueType::),
                MAP_PAIR(MUIA_TextEditor_InactiveContents, ValueType::),
        */
